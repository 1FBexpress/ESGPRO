...
const STEPS = [
  ...
  },
  {
    ...
    question: "What do you need to get going?",
    explanation: "Tell us about your ESG goals - are you pursuing certifications like B Corp or EcoVadis, meeting tender requirements, or building sustainability?",
    quickReplies: null,
    validate: (value) => {
      if (!value || value.trim().length < 5) {
        return { valid: false, message: "Please describe what you need - this helps us recommend the right path forward." };
      }
      return { valid: true, value: value.trim() };
    },
